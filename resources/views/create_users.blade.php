...
<a href="/dashboard/showUsers" class="btn btn-warning">Show Users</a><br>
<h1 class="text-center mt-3" style="font-size:45px;">Add Users</h1>
<form method="post" action="/dashboard/postaddUsers" enctype="multipart/form-data">
   @csrf()    
   @if(Session::has('errMsg'))
    ...
    <div class="form-group">
          ...
          <br><span class="alert alert-danger" role="alert">{{$errors->first('c_password')}}</span>
          @endif
    </div>
      <div class="form-group">
          <label>Role</label>
